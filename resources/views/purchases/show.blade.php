<x-layout title="Purchase Details - Al Nafi Travels" pageTitle="Purchase Details"
    ...
    <div class="print-footer">
        ...
        <p style="font-size: 10px; margin-top: 15px; color: #999;">Generated by Al Nafi Travels Management System</p>
    </div>
